...
class ConceptNode: 
  def __init__(self,
               ...
               created, expiration, 
               s, p, o, 
               description, embedding_key, poignancy, keywords, filling, dist=0): 
  ...
  def spo_summary(self): 
    return (self.subject, self.predicate, self.object, self.dist)
  
  def spodesc_summary(self):
    return (self.subject, self.predicate, self.object, self.description)
  
  def __repr__(self):
    return str(self.spo_summary()) + " - (Concept Node)"
  def __str__(self):
    return str(self.spo_summary())+ " - (Concept Node)"


class AssociativeMemory: 
  def __init__(self, f_saved, new): 
  ...
  def add_event(self, created, expiration, s, p, o, 
    ...
    node = ConceptNode(node_id, node_count, type_count, node_type, depth,
                       ...
                       poignancy, keywords, filling, dist)
  ...
  def get_latest_events(self, retention):
    ret_set = set()
    for e_node in self.seq_event[:retention]: 
      ret_set.add(e_node.spodesc_summary())
    return ret_set
