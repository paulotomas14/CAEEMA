...
class Scratch: 
  def __init__(self, f_saved, curr_time): 
    ...
    self.previously_chatting_with = None

    self.previously_chatting_with_buffer = dict()
    ...
    if check_if_file_exists(f_saved): 
      ...
      if scratch_load["act_event"] is None:
        self.act_event = tuple((self.name, " is " , "idle"))
      else:
      ...
      if scratch_load["act_obj_event"] is None:
        self.act_obj_event = None
      else:
  ...
  def save(self, out_json):
    ...
    #print("SAVE SCRATACH = "+ str(scratch))
  ...
  def get_str_iss(self, trim = False): 
    """
    ...
    if trim == False:
      commonset += f"Morning Thoughts: {self.currently}\n"
      commonset += f"Daily plan requirement: {self.daily_plan_req}\n"
      commonset += f"Current Date: {self.curr_time.strftime('%A %B %d')}\n"
      commonset += f"Current time: {self.curr_time.strftime('%H:%M')}\n"


      commonset += self.calendar.get_appointments(self)
  ...
  def add_new_action(self, 
    ...
    #print(f"{self.name} SAVING NEW ACTION = " + str(self.act_event))
    #print("CHAT = " + str(self.chat))
    #print("HUAHUAHU = " + str(self.chatting_with_buffer))
  ...
  def act_check_finished(self): 
    ...
    #print("END TIME = " + str(end_time.strftime("%H:%M:%S")))
    #print("CURR TIME = " + str(self.curr_time.strftime("%H:%M:%S")))
